...
class Index extends  Controller
{
    ...
    public function index($cid = 0, $keyword = '', $page = 1)
    {
        ...
        $article_list = $this->article_model->alias('a')->where('a.cid',1)->field('a.*,g.thumb c,g.id aid,g.name name')->join('grand g','a.author=g.id','LEFT')->order(['a.publish_time' => 'DESC'])->paginate(15, false, ['page' => $page]);
