...
-- ----------------------------
INSERT INTO `os_admin_user` VALUES ('1', 'admin', '0dfc7612f607db6c17fd99388e9e5f9c', '1', '2016-10-18 15:28:37', '2018-04-25 09:52:28', '127.0.0.1');
...
CREATE TABLE `os_grand` (
  ...
  `publish_time` datetime NOT NULL COMMENT '发布时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='大师用户表';
...
INSERT INTO `os_grand` VALUES ('17', '民间巨匠', '', '', '1', '/uploads/20180425/7e895cca00f0fee7a002de36dd598bfa.jpg', '0', '0', '0', '2018-04-25 16:44:33', '2018-04-25 16:42:53');
INSERT INTO `os_grand` VALUES ('18', '陈江南', '陈江南，苏派玉雕大师，国家高级玉雕师，苏州玉雕委员会副会长。擅长恢弘写意之风格，作品浑厚大气，雕工精细，尤重意境，不囿于刻板传统，刚柔结合，独具江南情怀。尤精于忠义关公雕刻，以女性视角观察关公文化、历史背景与人物性格，以超脱于传统的俊逸手法，将内心的关公形象呈现出来。既有豪迈大气的洒脱，又有江南婉约的柔美，刚柔兼济，令人叹为观止，堪称关公玉雕第一人。', '', '1', '/uploads/20180425/8f44a3f6ecc2e5bf0f8e5e3c7dedc993.jpg', '0', '0', '0', '2018-04-25 17:01:51', '2018-04-25 17:01:13');
