...
CREATE TABLE `os_article` (
  ...
  `good_num` int(11) DEFAULT '0' COMMENT '赞的数量',
  `bad_num` int(11) DEFAULT '0' COMMENT '踩的数量',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `os_user_good_bad` VALUES ('1', '23', '1', '0', '0');
INSERT INTO `os_user_good_bad` VALUES ('2', '25', '1', '0', '0');
INSERT INTO `os_user_good_bad` VALUES ('3', '22', '1', '0', '0');
