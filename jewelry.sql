...
(1, 'admin', '0dfc7612f607db6c17fd99388e9e5f9c', 1, '2016-10-18 15:28:37', '2018-04-11 13:17:13', '127.0.0.1'),
(2, 'admin1', '768c3212c5c4afd45fdf2b4663bd2ba5', 1, '2018-04-11 13:13:34', '2018-04-11 13:16:06', '127.0.0.1');
...
INSERT INTO `os_article` (`id`, `cid`, `title`, `introduction`, `materials`, `wanningtip`, `jmoney`, `pro_size`, `pro_weight`, `pro_color`, `pro_structure`, `pro_oiliness`, `pro_fat`, `pro_defect`, `word_meaning`, `content`, `author`, `status`, `reading`, `thumb`, `photo`, `is_top`, `is_recommend`, `sort`, `create_time`, `publish_time`) VALUES
(1, 1, '测试产品内容', '', '测试', '测试', '测试', '测试', '测试', '测试', '测试', '', '', '', '', '<p>测试内容</p>', '测试', 1, 0, '', NULL, 0, 0, 0, '2017-04-11 14:10:10', '2017-04-11 14:09:45');
...
(1, '超级管理组', 1, '1,2,3,73,74,5,6,7,8,9,10,11,12,39,40,41,42,43,14,13,20,21,22,23,24,38,15,25,26,27,28,29,30,16,17,44,45,46,47,48,18,49,50,51,52,53,19,31,32,33,34,35,36,37,54,55,58,59,60,61,62,56,63,64,65,66,67,57,68,69,70,71,72'),
(2, '文章管理组', 1, '14,13,20,21,22,23,24,38,15,25,26,27,28,29,30');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='规则表' AUTO_INCREMENT=75 ;
...
(38, 'admin/Grand/index', '玉雕大师管理', 1, 1, 14, 'fa fa-sitemap', 0, ''),
(14, 'admin/Content/default', '内容管理', 1, 1, 0, 'fa fa-file-text', 0, ''),
(15, 'admin/Article/index', '产品管理', 1, 1, 14, '', 0, ''),
...
(25, 'admin/Article/add', '添加产品', 1, 0, 15, '', 0, ''),
(26, 'admin/Article/save', '保存产品', 1, 0, 15, '', 0, ''),
(27, 'admin/Article/edit', '编辑产品', 1, 0, 15, '', 0, ''),
(28, 'admin/Article/update', '更新产品', 1, 0, 15, '', 0, ''),
(29, 'admin/Article/delete', '删除产品', 1, 0, 15, '', 0, ''),
(30, 'admin/Article/toggle', '产品审核', 1, 0, 15, '', 0, ''),
...
CREATE TABLE IF NOT EXISTS `os_grand` (
  ...
  `publish_time` datetime NOT NULL COMMENT '发布时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='大师用户表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `os_grand`
--

INSERT INTO `os_grand` (`id`, `cid`, `name`, `introduction`, `content`, `status`, `thumb`, `photo`, `is_top`, `is_recommend`, `sort`, `create_time`, `publish_time`) VALUES
(2, 1, '测试', '测试', '<p>测试</p>', 1, '12321', NULL, 0, 0, 0, '2018-04-11 10:20:03', '2018-04-11 10:19:34');
...
CREATE TABLE IF NOT EXISTS `os_reservation` (
  ...
  `re_way` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '预约时间',
  `re_cont` varchar(255) DEFAULT '' COMMENT '留言',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `status` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='预约表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `os_reservation`
--

INSERT INTO `os_reservation` (`id`, `name`, `re_introduction`, `re_local`, `re_way`, `re_cont`, `create_time`, `status`) VALUES
(2, '13', '', NULL, 0, '', '2018-04-17 02:18:24', 0);
...
(1, 'site_config', 'a:7:{s:10:"site_title";s:27:"琢玉界后台管理系统";s:9:"seo_title";s:0:"";s:11:"seo_keyword";s:0:"";s:15:"seo_description";s:0:"";s:14:"site_copyright";s:0:"";s:8:"site_icp";s:0:"";s:11:"site_tongji";s:0:"";}');
